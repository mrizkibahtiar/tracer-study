...
router.put('/admin/profile-edit/:adminId', isAdmin, adminController.alumniUpdate);
router.put('/admin/profile-edit/password/:adminId', isAdmin, adminController.alumniUpdatePassword);
