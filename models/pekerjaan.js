...
const pekerjaanSchema = new mongoose.Schema({
    ...
    duration: { type: Number, required: true }, // Dalam bulan
    salary: { type: Number, optional: true }, // Opsional
    responsibilities: { type: String, optional: true }, // Tanggung jawab di pekerjaan
});
